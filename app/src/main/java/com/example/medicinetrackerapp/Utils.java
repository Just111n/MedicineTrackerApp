...
//            throw e;
   ...
   /* Since it's JSON, adding a newline isn't necessary (it won't affect
     ...
     * @param  medName a string containing a medName
     * @return a URL object
     */
    ...
    private static URL buildURL(String medName) {
        ...
        try {
            ...
            Log.i(Utils.UTILS_TAG, "URL OK: " + url.toString());
        } catch (MalformedURLException e) {
            Log.i(Utils.UTILS_TAG, "malformed URL: " + url.toString());
        }
    ...
    static String getJsonFromApi(URL url) throws IOException {
        return getJson(url);
    }
